...
local perl_5_10_1 = bashStep {
  ...
  PATH = mkBinPath {
    ...
    boot.diffutils["2.7"],
    boot.grep["2.4"],
    boot.bison["2.3"], -- Intentionally using an old version.
    boot.flex["2.6.4"],
    boot.m4["1.4.7"],
    boot.bash["5.2.15"],
    boot.coreutils["9.4"],
  ...
  tarballs = {
    fetchurl {
      ...
      hash = "sha256:9385f2c8c2ca8b1dc4a7c31903f1f8dc8f2ba867dc2a9e5c93012ed6b564e826";
    },
  };
}
...
boot.dist = bashStep {
  ...
  tarballs = {
    fetchurl {
      ...
      hash = "sha256:05fa4f6ea9f05adf8f577699cb3f5b88b20dfce86b0d0cebbfb072fe5933d38f";
    },
  };
}

boot.perl["5.32.1"] = bashStep {
  pname = "perl";
  version = "5.32.1";
  ...
  tarballs = {
    fetchurl {
      ...
      hash = "sha256:57cc47c735c8300a8ce2fa0643507b44c4ae59012bfdad0121313db639e02309";
    },
    fetchurl {
      url = "http://deb.debian.org/debian/pool/main/p/perl/perl_5.32.1.orig-regen-configure.tar.gz";
      hash = "sha256:1d179b41283f12ad83f9758430f6ddc49bdf20db5c396aeae7e51ebb4e4afd29";
    },
  };
}

boot.libarchive = bashStep {
  pname = "libarchive";
  version = "3.5.2";
  ...
  tarballs = {
    fetchurl {
      ...
      hash = "sha256:f0b19ff39c3c9a5898a219497ababbadab99d8178acc980155c7e1271089b5a0";
    },
  };
}

boot.openssl = bashStep {
  pname = "openssl";
  version = "3.0.13";
  ...
  tarballs = {
    fetchurl {
      url = "http://ftp.openssl.org/source/openssl-3.0.13.tar.gz";
      hash = "sha256:88525753f79d3bec27d2fa7c66aa0b92b3aa9498dafd93d7cfa4b3780cdae313";
    },
  };
}
...
boot.gettext = bashStep {
  ...
  tarballs = {
    fetchGNU {
      path = "gettext/gettext-0.21.tar.xz";
